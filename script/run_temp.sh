...
do
  ...
  do
    ...
    do
      ...
      export model_name_or_path=/mnt/sda3/cjz/pretrained-models/t5-base
      ...
      export seed=3407
      export output_dir=./outputs/${task_name}/${dataset}_seed${seed}/shot/${shot}
