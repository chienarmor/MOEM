...
with open("./utils/force_tokens.json", 'r') as f:
...
optim_orders_all = {
    # "aste": {
    #     "laptop14": [
    #         '[opinion] [aspect] [sentiment]', '[aspect] [opinion] [sentiment]', '[opinion] [sentiment] [aspect]',
    #         '[aspect] [sentiment] [opinion]', '[sentiment] [opinion] [aspect]', '[sentiment] [aspect] [opinion]'
    #     ],
    #     "rest14": [
    #         '[opinion] [aspect] [sentiment]', '[opinion] [sentiment] [aspect]', '[aspect] [opinion] [sentiment]',
    #         '[aspect] [sentiment] [opinion]', '[sentiment] [opinion] [aspect]', '[sentiment] [aspect] [opinion]'
    #     ],
    #     "rest15": [
    #         '[aspect] [opinion] [sentiment]', '[opinion] [aspect] [sentiment]', '[opinion] [sentiment] [aspect]',
    #         '[aspect] [sentiment] [opinion]', '[sentiment] [opinion] [aspect]', '[sentiment] [aspect] [opinion]'
    #     ],
    #     "rest16": [
    #         '[opinion] [aspect] [sentiment]', '[aspect] [opinion] [sentiment]', '[opinion] [sentiment] [aspect]',
