    ...
    def __post_init__(self):
        ...
        if self.multi_task:
            if shot != -1:
                ...
                self.train_path = f'data/{self.task_name}/{self.dataset}-shot/{shot}/seed3407/train.txt'
                self.valid_path = f'data/{self.task_name}/{self.dataset}-shot/{shot}/seed3407/dev.txt'
                self.test_path = f'data/{self.task_name}/{self.dataset}-shot/{shot}/seed3407/test.txt'
            elif ratio != -1:
                ...
                self.train_path = f'data/{self.task_name}/{self.dataset}-ratio/{ratio}/seed3407/train.txt'
                self.valid_path = f'data/{self.task_name}/{self.dataset}-ratio/{ratio}/seed3407/dev.txt'
                self.test_path = f'data/{self.task_name}/{self.dataset}-ratio/{ratio}/seed3407/test.txt'
            else:
                ...
                self.train_path = f'data/{self.task_name}/{self.dataset}/seed3407/train.txt'
                self.valid_path = f'data/{self.task_name}/{self.dataset}/seed3407/dev.txt'
                self.test_path = f'data/{self.task_name}/{self.dataset}/seed3407/test.txt'
                # self.test_path = f'./data/aste/unified/rest15.txt'
        else:
            self.train_path = f'data/{self.dataset}/seed3407/train.txt'
            self.valid_path = f'data/{self.dataset}/seed3407/dev.txt'
            self.test_path = f'data/{self.dataset}/seed3407/test.txt'
